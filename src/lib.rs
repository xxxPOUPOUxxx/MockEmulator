...
#[derive(Debug)]
pub struct MockEmulatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MockEmulatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MockEmulator processing");
    
    let mut processor = MockEmulatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MockEmulatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MockEmulatorProcessor::new(false);
